class StageUtils extends BaseClass {
	...
	private static isIphoneX():boolean{
		return (734 == window.innerHeight && 375 == window.innerWidth) ||
      (812 == window.innerHeight && 375 == window.innerWidth) ||
      (896 == window.innerHeight && 414 == window.innerWidth) ||
      (818 == window.innerHeight && 414 == window.innerWidth) 
	}
	public static isIphone11():boolean{
		return (828 == window.innerHeight && 1792 == window.innerWidth) ||
      (1125 == window.innerHeight && 2436 == window.innerWidth) ||
      (1242 == window.innerHeight && 2688 == window.innerWidth)||
	  (734 == window.innerWidth && 375 == window.innerHeight) ||
